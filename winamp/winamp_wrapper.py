...
def load_preset(preset_path_or_string, smooth_transition=False, load_from_cache=False, timing=True, quiet=False):
    ...
    result = winamp_visual.load_preset(str(preset_path_to_load), smooth_transition, load_from_cache)
    if timing:

...
def download_song(url):
    ...
    new_effect = generate_show.generate_show(filepath, effects_config, songs_config[filepath]['duration'], overwrite=True, simple=False, debug=True)
...
if args.autogen:
    ...
    if args.show:
        ...
        new_effect = generate_show.generate_show(song_path, effects_config, songs_config[song_path]['duration'], overwrite=True, simple=args.autogen_simple)
        ...
        for name, path in get_all_paths('songs', only_files=True):
            new_effect = generate_show.generate_show(path, effects_config, songs_config[path]['duration'], overwrite=True, simple=args.autogen_simple, debug=False)

...
effects = {
    ...
    "Accel Wrap": {"profiles": ['Fun Grid'], "trigger": "toggle", "loop": True, "beats": [grid_f(1, function=accel_wrap, length=1),]},
    "Accel No Wrap": {"profiles": ['Fun Grid'], "trigger": "toggle", "loop": True, "beats": [grid_f(1, function=accel_nowrap, length=1),]},

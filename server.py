...
def find_show_name(name):
    valid_show_names = list(effects_config.keys())
    name = name.lower()
    all_canidates = []
...
if args.autogen:
    ...
    show = effects_config[find_show_name(args.show)]
    new_effect = generate_show.generate_show(show['song_path'])
...
async def start_async():
    ...
    if args.show:
        args.show = find_show_name(args.show)

...
effects = {
    ...
    "Justice - Genesis": {
        ...
        "beats": [
            ...
            b(10, name='Pink bottom', length=1, intensity=(1, 0)), 
            b(11, name='Green bottom', length=1,intensity=(1, 0)), 
            b(12, name='Pink bottom', length=1, intensity=(1, 0)), 
            b(13, name='Green bottom', length=1, intensity=(1, 0)), 
            b(14, name='Pink bottom', length=1,  intensity=(1, 0)), 
            ...
            b(26, name='Pink bottom', length=1, intensity=(1, 0)), 
            b(27, name='Green bottom', length=1,intensity=(1, 0)), 
            b(28, name='Pink bottom', length=1, intensity=(1, 0)), 
            b(29, name='Green bottom', length=1, intensity=(1, 0)), 
            b(30, name='Pink bottom', length=1,  intensity=(1, 0)), 
            b(31, name='Green bottom', length=3.75, intensity=(1, 0)), 
            # do.... 
            b(34.75, name='Blue bottom', length=7.25, intensity=(1, 0)), 

            # repeat do-do-do-do-do equally spaced
            b(42, name='Pink bottom', length=1, intensity=(1, 0)), 
            b(43, name='Green bottom', length=1,intensity=(1, 0)), 
            b(44, name='Pink bottom', length=1, intensity=(1, 0)), 
            b(45, name='Green bottom', length=1, intensity=(1, 0)), 
            b(46, name='Pink bottom', length=1,  intensity=(1, 0)), 
            ...
            # Second set of 3
            b(58.75, name='Yellow bottom', length=1, intensity=(1, 0)), 
            b(59.75, name='Blue bottom', length=1.5, intensity=(1, 0)), 

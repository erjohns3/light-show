effects = {
    ...
    'porter piano melody': {
        ...
        'beats': [
            ...
            [13, 'Seafoam bottom', 4, 1, 0],
            [15, 'Seafoam bottom', 2, 1, 0],
            [17, 'Seafoam bottom', 4, 1, 0],
            [21, 'Seafoam bottom', 4, 1, 0],
            [25, 'Seafoam bottom', 4, 1, 0],
            [29, 'Seafoam bottom', 2, 1, 0],
            [31, 'Seafoam bottom', 2, 1, 0],
        ],
    },
    'porter robinson  a breath superbloom edit show': {
        ...
        'skip_song': 0.0,
        'beats': [
            [1, 'porter flubs phrase rotating', 128],
            [17, 'porter piano melody', 32],
            [49, 'porter piano melody', 32, 1, 1, 0, .5, -.2],
            # [81, 'Red top', 1],
            [145, 'Red top', 1], # kicks
        ],
    }

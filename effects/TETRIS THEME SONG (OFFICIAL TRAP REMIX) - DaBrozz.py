...
effects = {
    "tetris drop": {
        ...
        "beats": [
            ...
            grid_f(1.30, function=tetris, beat_divide=12, length=.70),
        ]
    },
    "TETRIS THEME SONG (OFFICIAL TRAP REMIX) - DaBrozz": {
        ...
        "beats": [
            ...
            grid_f(1, function=tetris, beat_divide=12, length=129),
            grid_f(128, text='OY', font_size=8, length=1.5),
            # !TODO offset might be wrong 
            b(129.5, name='tetris drop', offset=.5, length=34.5),
            grid_f(164, text='WHAT', font_size=8, length=1.5),
            b(165.5, name='tetris drop', offset=.5, length=193 - 165.5),
            grid_f(193, function=tetris, beat_divide=12, length=129),
        ]
    }
}
...
for name2, path2 in get_all_paths(ray_songs_folder, only_files=True, recursive=True, allowed_extensions=allowed_extensions):
    for name1, path1 in get_all_paths(songs_folder, only_files=True, recursive=True, allowed_extensions=allowed_extensions):

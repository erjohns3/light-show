...
effects = {
    ...
    "circle pulse": {
        "beats": [
            grid_f(
                ...
                object=get_centered_circle_numpy_nofill(radius=1, color=GColor.white, offset_y=0),
                name='Ok 1',
                start_pos=(0, 0),
            ...
            grid_f(
                0.25,
                function=our_transform,
                object=get_centered_circle_numpy_nofill(radius=2, color=GColor.white, offset_y=0),
                name='Ok 2',
                start_pos=(0, 0),
                start_color=(100,100,100),
                end_color=(0, 0, 0),
            ...
            grid_f(
                0.375,
                function=our_transform,
                object=get_centered_circle_numpy_nofill(radius=3, color=GColor.white, offset_y=0),
                name='Ok 3',
                start_pos=(0, 0),
                start_color=(100,100,100),
                end_color=(0, 0, 0),
            ...
            grid_f(
                0.5,
                function=our_transform,
                object=get_centered_circle_numpy_nofill(radius=4, color=GColor.white, offset_y=0),
                name='Ok 4',
                start_pos=(0, 0),
                start_color=(100,100,100),
                end_color=(0, 0, 0),
            ...
            grid_f(
                .625,
                function=our_transform,
                object=get_centered_circle_numpy_nofill(radius=5, color=GColor.white, offset_y=0),
                name='Ok 5',
                start_pos=(0, 0),
                start_color=(100,100,100),
                end_color=(0, 0, 0),
            ...
            grid_f(
                .75,
                function=our_transform,
                object=get_centered_circle_numpy_nofill(radius=6, color=GColor.white, offset_y=0),
                name='Ok 6',
                start_pos=(0, 0),
                start_color=(100,100,100),
                end_color=(0, 0, 0),
            ...
            grid_f(
                .875,
                function=our_transform,
                object=get_centered_circle_numpy_nofill(radius=7, color=GColor.white, offset_y=0),
                name='Ok 7',
                start_pos=(0, 0),
                start_color=(100,100,100),
                end_color=(0, 0, 0),
    ...
    "Lykke Li - I Follow Rivers (The Magician Remix)": {
        ...
        "beats": [
            ...
            b(1, name="circle pulse", length=100),
